...
function objectAssign(target, ...sources) {
    ...
    for (const key of [...Object.getOwnPropertyNames(result), ...Object.getOwnPropertySymbols(result)]) {
        const objectDescriptor = Object.getOwnPropertyDescriptor(result, key)
