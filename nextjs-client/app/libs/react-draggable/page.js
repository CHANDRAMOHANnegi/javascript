    ...
    return (
      <div>
        ...
        <Draggable {...dragHandlers}>
          <div className={styles.box}>I can be dragged anywhere</div>
        </Draggable>
        <Draggable axis="x" {...dragHandlers}>
          <div className={styles.box + " " + styles["cursor-x"]}>
            I can only be dragged horizonally (x axis)
          </div>
        </Draggable>
        <Draggable axis="y" {...dragHandlers}>
          <div className={styles.box + " " + styles["cursor-y"]}>
            I can only be dragged vertically (y axis)
          </div>
        </Draggable>
        <Draggable onStart={() => false}>
          <div className={styles.box}>I don't want to be dragged</div>
        </Draggable>
        ...
        <Draggable handle="strong" {...dragHandlers}>
          <div className={styles.box + " " + styles["no-cursor"]}>
            <strong className={styles.cursor}>
              <div>Drag here</div>
            </strong>
        ...
        <Draggable handle="strong">
          <div
            className={styles.box + " " + styles["no-cursor"]}
        ...
        <Draggable cancel="strong" {...dragHandlers}>
          <div className={styles.box}>
            <strong className={styles["no-cursor"]}>Can't drag here</strong>
            <div>Dragging here works</div>
          </div>
        </Draggable>
        <Draggable grid={[25, 25]} {...dragHandlers}>
          <div className={styles.box}>I snap to a 25 x 25 grid</div>
        </Draggable>
        <Draggable grid={[50, 50]} {...dragHandlers}>
          <div className={styles.box}>I snap to a 50 x 50 grid</div>
        </Draggable>
        <Draggable
        ...
        <Draggable {...dragHandlers}>
          <div
            className={styles.box + " " + styles["drop-target"]}
        ...
        <Draggable {...dragHandlers} onStop={this.onDrop}>
          <div
            className={`${styles.box} ${
              this.state.activeDrags ? styles["no-pointer-events"] : ""
            }`}
          >
        ...
        <Draggable {...dragHandlers}>
          <RemWrapper>
            <div
              className={styles.box + " " + styles["rem-position-fix"]}
              style={{
                position: "absolute",
                bottom: "6.25rem",
                right: "18rem",
